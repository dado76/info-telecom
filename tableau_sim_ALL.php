...
<button><a href="addsim.php">Ajouter</a></button><button><a href="simadd.php">Excel</a></button><button><a href="simadd.php">Imprimer</a></button>
...
<br>
    ...
    <?php
     ...
     ?>
  	<td><a href="simedit.php?id=<?php echo $donnees["Codification"]; ?>">
